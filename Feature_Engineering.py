...
if __name__ == '__main__':
    writer = SummaryWriter("log/exp31")
    global_step = 1
    ...
    for k in range (0, epochs):
        ...
        writer.add_scalar('Validation/Absolute Accuracy', average_abs[k], global_step)
        writer.add_scalar('Validation/Relative Error', average_percent[k], global_step)
        writer.add_scalar('Validation/Loss: MSE', loss_set_iteration[k], global_step)
        global_step += 1
        epoch_count += 1
    writer.close()
